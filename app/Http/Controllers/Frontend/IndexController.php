...
class IndexController extends Controller
{
    public function CourseDetails($id, $slug)
    {
        ...
        // lấy id giảng viên của course này
        $ins_id = $course->instructor_id;
        // lấy tất cả courses của giảng viên này
        $instructorCourses = Course::where('instructor_id', $ins_id)->where('id', '!=', $id)->orderBy('id', 'DESC')->get();
        ...
        return view('frontend.course.course_details', compact('course', 'goals', 'instructorCourses', 'relatedCourses', 'categories'));
    } // End Method

    public function CategoryCourse($id, $slug)
    {
        // lấy all courses của category này
    ...
    public function InstructorDetails($id)
    {
        ...
        return view('frontend.instructor.instructor_details', compact('instructor', 'courses', 'allCourses'));
    } // End Method 
}
