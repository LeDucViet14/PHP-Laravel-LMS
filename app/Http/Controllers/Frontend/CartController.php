...
class CartController extends Controller
{
    ...
    public function Payment(Request $request)
    {
        ...
        // tạo 1 arr trống và lấy thông tin từ request
        $data = array();
        ...
        if ($request->cash_delivery == 'stripe') {
            ...
            $data->invoice_no = 'VN' . mt_rand(10000000, 99999999);
    ...
    public function StripeOrder(Request $request)
    {
        ...
        \Stripe\Stripe::setApiKey('sk_test_51PipYTCJW2jgxQ5pJF3cWCwRQLlUHj09it6lpNDtkCuIk4DDAoBf0JUFuuZ9hCHKSgjquvuXFiV2oXOSHiddi3rZ008ClOUhiz');
