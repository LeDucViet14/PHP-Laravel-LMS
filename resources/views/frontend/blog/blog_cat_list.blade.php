            ...
            <div class="row">
                <div class="col-lg-8 mb-5">
                    <div class="row">
                        ...
                        @empty
                            <h4 class="text-danger">No Blog Found</h4>
                        @endforelse
                            ...
                            <div class="card-body">
                                ...
                                @foreach ($post as $dpost)
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        <a href="{{ url('blog/details/' . $dpost->id . '/' . $dpost->post_slug) }}"
                                            class="media-img">
                                        ...
                                        <div class="media-body">
                                            <h5 class="fs-15"><a
                                                    href="{{ url('blog/details/' . $dpost->id . '/' . $dpost->post_slug) }}">{{ $dpost->post_title }}</a>
                                            </h5>
