            ...
            <ul class="user">
                ...
                <li v-for="(user, index) in users" :key="index">
                    <a href="" @click.prevent="userMessage(user.id)">
                        ...
                        <img v-else :src="'/upload/instructor_images/'+user.photo" alt="UserImage" class="userImg" />
            ...
            <div class="card">
                    ...
                    <ul class="chat" v-for="(msg,index) in allmessages.messages" :key="index">
                        ...
                        <li class="sender clearfix" v-if="allmessages.user.id === msg.sender_id">
                            <span class="chat-img left clearfix mx-2">
                                <img :src="'/upload/instructor_images/'+msg.user.photo" class="userImg" alt="userImg" />
                            </span>
                ...
                <div class="card-footer">
                    <div class="input-group">
                        <input id="btn-input" v-model="msg" type="text" class="form-control input-sm" placeholder="Type your message here..." />
